...
class Empresa(models.Model):
    ...
    funcao_mercado_de_trabalho = models.CharField(
    	'funcao_mercado_de_trabalho',
    	max_length = 50
    	)
...
class Estagio(models.Model):
    ...
    hr_inicial = models.CharField(
    	'hr_inicial',
    	max_length = 5
    	)


    hr_final = models.CharField(
    	'hr_final',
    	max_length = 5
    	)


    periodo_semanal = models.CharField(
    	'periodo_semanal',
    	max_length = 30
    	)


    dia_inicio = models.CharField(
    	'dia_inicio',
    	max_length = 10
    	)


    dia_fim = models.CharField(
    	'dia_fim',
    	max_length = 10
    	)


    duracao_minima = models.CharField(
    	'duracao_minima',
    	max_length = 10
    	)
    ...
    local_do_estagio = models.CharField(
    	'local_do_estagio',
    	max_length = 30
    	)
